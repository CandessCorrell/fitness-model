...
INSERT INTO users (team_name, password) VALUES
	('DIDITRails', '$2a$10$rMzQQxnYvbZwGfcRjyfthe4QIgrca3bafk2nvY7Bq/bGk9ZnUS2DW'),
	('DIDITColdFusion', '$2a$10$rMzQQxnYvbZwGfcRjyfthe4QIgrca3bafk2nvY7Bq/bGk9ZnUS2DW'),
	('ELIS', '$2a$10$rMzQQxnYvbZwGfcRjyfthe4QIgrca3bafk2nvY7Bq/bGk9ZnUS2DW');
...
INSERT INTO assessments (user_id, version_id, start_time, end_time) VALUES
	...
	(1, 1, '2016-12-21T17:00:57.484Z', '2016-12-21T18:00:57.484Z'),
	(2, 1, '2016-12-21T17:00:57.484Z', '2016-12-21T18:00:57.484Z'),
	(3, 1, '2016-12-21T17:00:57.484Z', '2016-12-21T18:00:57.484Z');

INSERT INTO responses (answer_id, question_id, assessment_id) VALUES
-- Assessment 1 is all NO's for team 'DIDITRails'
	(1, 1, 1),
	(4, 2, 1),
	(7, 3, 1),
	(10, 4, 1),
	...
	(58, 20, 1),
	(61, 21, 1),
-- Assessment 2 is all Level 1's for team 'DIDITColdFusion'
	(2, 1, 2),
	(5, 2, 2),
	(8, 3, 2),
	(10, 4, 2),
	...
	(58, 20, 2),
	(61, 21, 2),
-- Assessment 3 is all NO's for team 'DIDITColdFusion'
	(1, 1, 3),
	(4, 2, 3),
	(7, 3, 3),
	(10, 4, 3),
	...
	(58, 20, 3),
	(61, 21, 3),
-- Assessment 4 is all NO's for team 'ELIS'
	(1, 1, 4),
	(4, 2, 4),
	(7, 3, 4),
	(10, 4, 4),
